        ...
        <section className="relative min-h-[90vh] bg-ivory-grain flex flex-col justify-center px-6 lg:px-12">
          <div className="mx-auto max-w-[1440px] grid gap-10 px-6 pb-20 pt-14 lg:min-h-[calc(100vh-140px)] lg:grid-cols-[0.95fr_1.05fr] lg:px-12">
            <div className="flex flex-col justify-center">
              ...
              <h1 className="mt-8 font-display text-[14vw] font-light leading-[0.86] tracking-[-0.04em] text-ink md:text-[7.5rem] lg:text-[9rem]">
                Fine jewellery<br />
            ...
            <div className="relative min-h-[500px] rounded-[44px] overflow-hidden bg-[#090705] flex items-center justify-center">
