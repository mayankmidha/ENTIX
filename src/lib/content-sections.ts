  ...
  home: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Choose by the moment the piece must hold.',
        body: 'Rooms replace category noise. Each path gives the shopper an emotional door and the practical detail to buy with confidence.',
      },
      {
        key: 'productRail',
        label: 'Product rail',
      ...
      },
      {
        ...
        enabled: true,
        position: 80,
        title: 'When the choice needs to feel personal.',
        body: 'Choose by certainty: earrings and pendants when sizing is unknown, rings when the fit is known, bangles when the gift needs presence.',
        imageUrl: entixImages.gifting,
        href: '/gift-guide',
        cta: 'Open edit',
      },
      {
