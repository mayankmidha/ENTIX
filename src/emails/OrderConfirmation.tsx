      ...
      >
        <Body className="bg-ivory my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eee] rounded my-[40px] mx-auto p-[20px] max-w-[465px] bg-white">
            ...
            <Text className="text-ink text-[14px] leading-[24px]">
              {introText || <>Thank you for your patronage. Your order <strong>{orderNumber}</strong> has been received and is currently being prepared.</>}
            </Text>
            <Section className="mt-[32px] mb-[32px]">
              ...
              <Row>
                <Column>
                  <Text className="text-ink text-[16px] font-bold m-0 italic">Total</Text>
                </Column>
                <Column align="right">
